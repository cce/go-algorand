...
GOTESTCOMMAND=${GOTESTCOMMAND:="go tool -modfile=tools.mod gotestsum --format testname --junitfile ${TEST_RESULTS}/results.xml --jsonfile ${TEST_RESULTS}/testresults.json --"}
