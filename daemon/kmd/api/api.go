...
//
//go:generate go tool -modfile=../../../tools.mod swagger generate spec -m --transparent-aliases -o="./swagger.json"
//go:generate go tool -modfile=../../../tools.mod swagger validate ./swagger.json --stop-on-error
