...
func initConsensusProtocols() {
	...
	v7 := ConsensusParams{
		...
		AgreementFilterTimeoutPeriod0: 1 * time.Second + 700 * time.Millisecond,
	...
	vFuture.AgreementFilterTimeoutPeriod0 = 1 * time.Second + 700 * time.Millisecond
