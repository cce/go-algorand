...
func TestMakeWsPeerMsgCodec_StatefulRequiresStateless(t *testing.T) {
	...
	require.False(t, codec.statefulVoteEnabled,
		"Stateful compression should not be enabled without stateless support")
	...
	require.True(t, codec.statefulVoteEnabled,
		"Stateful compression should be enabled when both stateless and dynamic are supported")
}
