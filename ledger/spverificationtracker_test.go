...
const (
	anyLocation StateProofTrackingLocation = iota
	trackerDB
	trackerMemory
)
...
func TestStateProofVerificationTracker_StateProofsDisabled(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, uint64(roundsAmount)/defaultStateProofInterval, defaultStateProofInterval, false, anyLocation)
}
...
func TestStateProofVerificationTracker_StateProofsNotStuck(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, expectedRemainingContextNum, defaultStateProofInterval, false, anyLocation)
	...
	verifyStateProofVerificationTracking(t, spt, finalLastAttestedRound, 1, defaultStateProofInterval, true, anyLocation)
}
...
func TestStateProofVerificationTracker_CommitFullDbPruning(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, maxStateProofsToGenerate, defaultStateProofInterval, false, anyLocation)
...
func TestStateProofVerificationTracker_CommitPartialDbPruning(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, contextToRemove, defaultStateProofInterval, false, anyLocation)
...
func TestStateProofVerificationTracker_StateProofIntervalChange(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, firstNewIntervalLastAttestedRound, newIntervalContext,
		newStateProofInterval, true, anyLocation)
	...
	verifyStateProofVerificationTracking(t, spt, firstNewIntervalLastAttestedRound,
		newIntervalRemovedStateProofs, newStateProofInterval, false, anyLocation)
