...
func TestMarshalUnmarshalcatchpointFileBalancesChunkV6Chan(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := catchpointFileBalancesChunkV6Chan{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingcatchpointFileBalancesChunkV6Chan(t *testing.T) {
	protocol.RunEncodingTest(t, &catchpointFileBalancesChunkV6Chan{})
}

func BenchmarkMarshalMsgcatchpointFileBalancesChunkV6Chan(b *testing.B) {
	v := catchpointFileBalancesChunkV6Chan{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgcatchpointFileBalancesChunkV6Chan(b *testing.B) {
	v := catchpointFileBalancesChunkV6Chan{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalcatchpointFileBalancesChunkV6Chan(b *testing.B) {
	v := catchpointFileBalancesChunkV6Chan{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
