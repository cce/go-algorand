...
func TestMarshalUnmarshalkvBlockHeaderValue(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := kvBlockHeaderValue{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingkvBlockHeaderValue(t *testing.T) {
	protocol.RunEncodingTest(t, &kvBlockHeaderValue{})
}

func BenchmarkMarshalMsgkvBlockHeaderValue(b *testing.B) {
	v := kvBlockHeaderValue{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgkvBlockHeaderValue(b *testing.B) {
	v := kvBlockHeaderValue{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalkvBlockHeaderValue(b *testing.B) {
	v := kvBlockHeaderValue{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalkvBlockValue(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := kvBlockValue{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingkvBlockValue(t *testing.T) {
	protocol.RunEncodingTest(t, &kvBlockValue{})
}

func BenchmarkMarshalMsgkvBlockValue(b *testing.B) {
	v := kvBlockValue{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgkvBlockValue(b *testing.B) {
	v := kvBlockValue{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalkvBlockValue(b *testing.B) {
	v := kvBlockValue{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
